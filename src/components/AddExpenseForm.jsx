...
const AddExpenseForm = () => {
  ...
  return (
    <div className="bg-slate-800 rounded-2xl shadow-md p-6 border border-slate-700 max-w-md mx-auto mt-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-400"
          />
        </div>
        ...
        <button
          type="submit"
          className="w-full bg-indigo-500 hover:bg-indigo-400 text-white font-semibold py-2 px-4 rounded-lg transition duration-300"
        >
          Add Expense
        </button>
      </form>
